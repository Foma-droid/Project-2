...
public class spawner : MonoBehaviour
{
    ...
    private void SpawnNewBall()
    {
        ...
        currentBall.GetComponent<Chromebeh>().Kinematic();
        canshoot = true;
    }
    ...
    void Update()
    {
        ...
        if (currentBall != null) // сразу избавляем себя от лишней ошибки
        {
            ...
            if (currentBall.transform.position.y < -10f) // Если наш текущий шар упадет слишком низко, значит можем считать его потраченным
            {
